...
type Props = {
    handleImageUsing: (checked: React.FormEvent<HTMLInputElement>) => void;
    checked: boolean;
}

export default function SwitchInput({handleImageUsing, checked}: Props) {
return (
    <div className='cursor-pointer'>
        <input type="checkbox" 
            onChange={handleImageUsing} 
            value="."
