...
export default function Login() {
          ...
          if (rez.data!.isSuccess) {
            toastMessage!.show({
              ...
              content: (props) => (
                <MessageToast
                  ...
                  message={`Пароль успешно изменен. Можно войти в систему под новым паролем`}
                />
              ),
            });
          } else {
            toastMessage!.show({
              ...
              content: (props) => (
                <MessageToast
                  toastType={ToastType.Info}
                  message={`Ошибка установки пароля - ${rez.data?.errorMessages}`}
                />
              ),
            });
          }
        ...
        .catch((e) => {
          toastMessage!.show({
            ...
            content: (props) => (
              <MessageToast
                toastType={ToastType.Info}
                message={`Ошибка установки пароля - ${e.message}`}
              />
            ),
          });
        });
  ...
  const handleSetNewPassword = () => {
    ...
    confirmDialog({
      ...
      message: (
        <div className="flex flex-column align-items-center text-4xl">
          <div>
    ...
    if (response.data && response.data.isSuccess) {
      ...
      toastMessage!.show({
        ...
        content: (props) => (
          <MessageToast
            toastType={ToastType.Info}
            message={`Успешный вход в систему пользователя ${
        ...
        <Panel className="LoginPanel">
          ...
          <div className="mt-4">
            <div className="field grid">
              <label className="col-fixed w-10rem text-4xl">
                Логин<span>*</span>
              </label>
              <div className="col">
                <FloatLabel>
