...
public class ItemConfiguration : IEntityTypeConfiguration<FinanceItem>
{
    ...
    {
        builder.ToTable("FinanceItems").HasKey(p => new { p.ItemId, p.Commited }).HasName("PK_FinanceItems");
        ...
        builder.HasIndex(p => new { p.ItemId, p.Commited }).IsUnique(true).HasDatabaseName("PX_FinanceItems");
