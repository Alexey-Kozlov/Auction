...
{
    p.AddConsumersFromNamespaceContaining<CreateTagConsumer>();
    p.SetEndpointNameFormatter(new KebabCaseEndpointNameFormatter("tag", false));
...
builder.Services.AddScoped<TagProceduresService>();
