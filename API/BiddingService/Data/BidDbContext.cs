...
public class AuctionConfiguration : IEntityTypeConfiguration<Auction>
{
    ...
    {
        builder.ToTable("Auctions").HasKey(p => p.AuctionId).HasName("PK_AuctionId");
        ...
        builder.HasIndex(p => p.AuctionId).HasDatabaseName("IX_Auctions");
    }
}
...
public class BidConfiguration : IEntityTypeConfiguration<Bid>
{
    ...
    {
        builder.ToTable("Bids").HasKey(p => p.BidId).HasName("PK_BidId");
        builder.Property(p => p.BidId).HasColumnType("uuid").HasColumnName("Id").IsRequired(true);
        ...
        builder.HasIndex(p => p.BidId).HasDatabaseName("IX_Bids");
