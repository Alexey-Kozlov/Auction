...
public class CommunicationUpdateProcessing
{
    ...
    public CommunicationUpdateProcessing(IPublishEndpoint publishEndpoint, EventSourcingDbContext dbContext,
    ...
    public async Task ProcessESLog(ConsumeContext<ESContract> context)
    {
        try
        {
            var result = await _dbContext.communication_update(
            ...
            _auctionMetrics.UpdateCommunication();
        ...
        catch (Exception e)
        {
            ...
            messageObject.GetType().GetProperty("ErrorServiceName").SetValue(messageObject, "EventSourcingService_CommunicationUpdate");
