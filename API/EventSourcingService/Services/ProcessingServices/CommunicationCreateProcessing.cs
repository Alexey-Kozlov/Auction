...
public class CommunicationCreateProcessing
{
    ...
    public CommunicationCreateProcessing(IPublishEndpoint publishEndpoint, EventSourcingDbContext dbContext,
    ...
    public async Task ProcessESLog(ConsumeContext<ESContract> context)
    {
        try
        {
            ...
            _auctionMetrics.AddCommunication();
        ...
        catch (Exception e)
        {
            ...
            messageObject.GetType().GetProperty("ErrorServiceName").SetValue(messageObject, "EventSourcingService_CommunicationCreate");
