...
public class CommunicationConfiguration : IEntityTypeConfiguration<CommunicationItem>
{
    ...
    {
        builder.ToTable("CommunicationItems").HasKey(p => p.Id).HasName("PK_CommunicationItems");
        ...
        builder.HasIndex(p => p.Id).IsUnique(true).HasDatabaseName("PX_CommunicationItems");
